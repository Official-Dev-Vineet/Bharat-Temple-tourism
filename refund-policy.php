...
<head>
    ...
    <title>Refund policy :Bharat Temple Tourism</title>
...
<body>
    ...
    <main>
        <section class="hero" id="home">
            <div class="container">
                <h2 class="h1 hero-title">Our Commitment to Fairness and Customer Satisfaction</h2>
            </div>
        </section>
        <section class="container refund-policy">
            <h1 class="mb-4">Refund Policy</h1>
            <p>We understand that plans can change, and sometimes trips need to be canceled. Below is our refund policy for payments made through PhonePe:</p>
            <ol>
                <li><strong>Refund Process:</strong> In case you need to cancel your trip and request a refund, please contact our site administrator at <a href="mailto:<?= $email ?>"><?= $email ?></a> with a valid reason for cancellation.</li>
                <li><strong>Reason for Refund:</strong> We require a valid reason for trip cancellation to process your refund. This helps us ensure that refunds are processed fairly and efficiently.</li>
                <li><strong>Refund Review:</strong> Once we receive your refund request and reason for cancellation, our site administrator will review your case. We may reach out to you for additional information if needed.</li>
                <li><strong>Refund Timeline:</strong> Upon approval of your refund request, we will initiate the refund process. Refunds will be processed within 4-5 business days from the date of approval.</li>
                <li><strong>Refund Method:</strong> Refunds will be processed using the same payment method used for the original transaction. For example, if you made the payment through PhonePe, the refund will be credited back to your PhonePe account.</li>
                <li><strong>Refund Status:</strong> You will be notified via email once your refund has been processed. Please note that the actual time it takes for the refund to reflect in your account may vary depending on your payment provider.</li>
                <li><strong>Non-Refundable Fees:</strong> Please note that certain fees, such as processing fees or non-refundable booking fees, may not be eligible for a refund. These fees will be clearly communicated to you at the time of booking.</li>
                <li><strong>Contact Us:</strong> If you have any questions or need further assistance regarding refunds, please feel free to contact our customer support team at <a href="mailto:<?= $email ?>"><?= $email ?></a>.</li>
            </ol>
        </section>
