...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo '<div class="gallery-item" id="gallery-item-' . $row['id'] . '"> <img src="' . $row['file_path'] . '" alt="' . $row['file_name'] . '"  class="img-fluid" />   <button onclick="deleteImage(' . $row['id'] . ')">Delete</button> </div>';
    }
}else{
