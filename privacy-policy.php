    ...
    <head>
        ...
        <title>Privacy policy : Bharat Temple Tourism</title>
    ...
    <body>
        ...
        <main>
            ...
            <section class="container privacy-content">
                ...
                <p>Your privacy is important to us at Bharat Temple Tourism. This privacy policy outlines how we collect, use, and protect your personal information when you visit our website.</p>
                <ol>
                    <li><strong>Information We Collect</strong>:
                        <ul>
                            <li><strong>Personal Information</strong>: When you book tours, subscribe to our newsletter, or contact us, we may collect personal information such as your name, email address, phone number, and billing details.</li>
                            <li><strong>Usage Data</strong>: We may collect data about how you interact with our website, including your IP address, browser type, pages visited, and referring website.</li>
                        </ul>
                    </li>
                    <li><strong>Use of Information</strong>:
                        <p>We use your personal information to process bookings, communicate with you, and provide customer support. Your usage data helps us improve our website's functionality, analyze trends, and enhance user experience.</p>
                    </li>
                    <li><strong>Data Security</strong>:
                        <p>We implement industry-standard security measures to protect your personal information from unauthorized access, disclosure, or alteration. However, please note that no method of transmission over the internet or electronic storage is 100% secure, and we cannot guarantee absolute security.</p>
                    </li>
                    <!-- Include other points -->
                </ol>
                <p>If you have any questions or concerns about our privacy practices or this privacy policy, please contact us at <a href="mailto:privacy@example.com">privacy@example.com</a>.</p>
            </section>
