...
<head>
    ...
    <meta name="google-signin-client_id" content="315721882428-a997qeiqhj2kb2c2gcna12f42dsq6029.apps.googleusercontent.com">
    <style>
        body {
...
<body>
    <div class="container">
        <h2 class="mt-5 mb-4 text-center text-primary">Welcome To bharat temple Tourism 😊</h2>
        <p class="mb-4 font-weight-bolder text-center">
            Already have an account? <a href="login.php">Login</a>
        </p>
        <form action="createUser.php" method="POST" enctype="multipart/form-data" id="registerForm">
        ...
        <div class="mt-4">
            <div id="g_id_onload" data-client_id="315721882428-a997qeiqhj2kb2c2gcna12f42dsq6029.apps.googleusercontent.com" data-callback="handleCredentialResponse">
            </div>
